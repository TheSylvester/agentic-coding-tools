...
- Save the prompt to a file `<project-root>/.ai-reference/prompts/<timestamp>-<task-description>.md`
- Use a filesystem-safe `<task-description>` (kebab-case, no slashes).
- **Timestamp format:** `YYYYMMDDHHMMSS` (e.g., `20260113185624` = 2026-01-13 18:56:24). Always include date AND time.
